...
<footer class="bottom-footer">
  <div class="container">
    <div class="row"> 
      ...
      <!--/contact details--> 
      <div class="col-md-12"><p class="copyright">© 2018 <a href="https://dcrazed.com/">Numero</a>. All rights reserved</p></div>
    </div>
  </div>
</footer>
...
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/dist/js/bootstrap.js"></script> 
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/dist/js/SmoothScroll.js"></script> 
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/dist/js/jquery.isotope.js"></script> 
<script src="<?php echo get_template_directory_uri(); ?>/dist/js/owl.carousel.js"></script> 
<script src="<?php echo get_template_directory_uri(); ?>/dist/js/jquery.waypoints.min.js"></script> 
<!-- Custom Javascripts
    ================================================== --> 
