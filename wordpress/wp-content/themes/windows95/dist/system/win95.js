...
$(document).ready(function()
{
  ...
  {
    if ($(event.target).closest('.win_titb_controls').length > 0)
    {
      return
    }
    if ($(this).hasClass("nores") == false)
    { // makes sure the window is re-sizable
  ...
  {
    if ($(event.target).closest('.win_titb_min').length > 0)
    {
      return
    }
  ...
  $("#win_container").on('mouseover', function()
  {
    ...
    $(".win_drag").draggable(
    {
      ...
      scroll: false,
      start: function()
      { // switches to window being dragged
  ...
  // dragElement(document.getElementById("win_window win_drag win_window_active"));
...
{ /* IT WORKS!!! What's the catch? */
  ...
  if (res != false && taskbar != false)
  { // all buttons
    var sec7 = '"><img src=" ' + themeUri + 'system/win_controls/min.png" class="win_titb_min" id"_"><img src="' + themeUri + 'system/win_controls/max.png" class="win_titb_max" id"_"><img src="' + themeUri + 'system/win_controls/close.png" class="win_titb_close" id"_"></div></div></div>';
  }
  else if (res == false && taskbar == false)
  { // only close
    var sec7 = '"><img src="' + themeUri + 'system/win_controls/close.png" class="win_titb_close" id"_"></div></div></div>';
  }
  else if (res == false)
  { // max. shaded out
    var sec7 = '"><img src="' + themeUri + 'system/win_controls/min.png" class="win_titb_min" id"_"><img src="' + themeUri + 'system/win_controls/max_disabled.png" class="win_titb_max_dis" id"_"><img src="' + themeUri + 'system/win_controls/close.png" class="win_titb_close" id"_"></div></div></div>';
  }
  else if (taskbar == false)
  { // no minimize button
    var sec7 = '"><img src="' + themeUri + 'system/win_controls/max.png" class="win_titb_max" id"_"><img src="' + themeUri + 'system/win_controls/close.png" class="win_titb_close" id"_"></div></div></div>';
  }
